...
class Football_Pool_Next_Prediction_Widget extends Football_Pool_Widget {
	...
	public function html( $title, $args, $instance ) {
		...
		$extra_texts = sprintf( "{'pre_before':'%1\$s','post_before':'%2\$s','pre_after':'%3\$s','post_after':'%4\$s'}"
								// translators: don't forgt the space at the end of the string
								, esc_js( __( 'Just ', 'football-pool' ) )
								// translators: don't forgt the space at the start of the string
								, esc_js( __( ' until', 'football-pool' ) )
								// translators: don't forgt the space at the end of the string
								, esc_js( __( 'started ', 'football-pool' ) )
								// translators: don't forgt the space at the start of the string
								, esc_js( __( ' ago:', 'football-pool' ) )
						);
