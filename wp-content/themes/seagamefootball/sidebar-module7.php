					...
					<div class="col-md-4">
						...
						<div class="widget">
							...
							<div id="owl-carousel-4" class="owl-carousel owl-theme owl-loaded owl-drag">
								...
								<!-- /ARTICLE -->
							<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-720px, 0px, 0px); transition: all 0.25s ease 0s; width: 2160px;"><div class="owl-item cloned" style="width: 360px;"><article class="article thumb-article">
									<div class="article-img">
								...
								</article></div><div class="owl-item cloned" style="width: 360px;"><article class="article thumb-article">
									<div class="article-img">
								...
								</article></div><div class="owl-item active" style="width: 360px;"><article class="article thumb-article">
									<div class="article-img">
										<img src="<?php echo $Url ?>/img/img-thumb-1.jpg" alt="">
									</div>
									<div class="article-body">
								...
								</article></div><div class="owl-item" style="width: 360px;"><article class="article thumb-article">
									<div class="article-img">
										<img src="<?php echo $Url ?>/img/img-thumb-2.jpg" alt="">
									</div>
									<div class="article-body">
								...
								</article></div></div></div><div class="owl-nav disabled"><div class="owl-prev">prev</div><div class="owl-next">next</div></div><div class="owl-dots"><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div></div></div>
							<!-- /owl carousel 4 -->
						</div>
						<!-- /article widget -->
